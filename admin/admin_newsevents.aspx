<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="admin_newsevents.aspx.cs" Inherits="admin_admin_newsevents" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="7" border="0">
            <tr>
                <td colspan="3" style="background-color: #363258">
                    <p style="color: White">
                        <font size="14">File Upload Section</font></p>
                </td>
            </tr>
            <tr>
                <td colspan="3">
